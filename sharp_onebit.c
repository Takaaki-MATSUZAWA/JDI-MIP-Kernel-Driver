...
// char commandByte = 0b10000000;  // three bit mode
char commandByte = 0b10001000;  // one bit mode
...
int thread_fn(void* v) 
{
	...
	screenBufferCompressed[y*(50+4) + 1] = y; // reverseByte(y+1); //sharp display lines are indexed from 1
